...
# data$num_f <- as.numeric(data$num_f)
# data$num_m <- as.numeric(data$num_m)
# data$num_nosex <- as.numeric(data$num_nosex)
# data$given_lat <- as.numeric(data$given_lat)
# data$given_long <- as.numeric(data$given_long)
